...
COMMENT ON COLUMN EMP.EMP_PERMANENTID IS '사원 구분';
COMMENT ON COLUMN EMP.EMP_DEPARTMENTID IS '직급';
COMMENT ON COLUMN EMP.EMP_JOBID IS '소속';
