...
public class QNoticeEntity extends EntityPathBase<NoticeEntity> {
    ...
    private static final long serialVersionUID = -1888104247L;
    ...
    public final org.ict.artpartM.emp.entity.QEmpEntity writer;
    ...
    public QNoticeEntity(Class<? extends NoticeEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.writer = inits.isInitialized("writer") ? new org.ict.artpartM.emp.entity.QEmpEntity(forProperty("writer")) : null;
    }
