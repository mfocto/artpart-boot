package org.ict.artpartM.common.security.jwt.provider;
...
import org.ict.artpartM.prop.SecProperties;
        ...
        if (isNotEmpty(tokenHeader)) {
            try {
                ...
                if (isNotEmpty(userId)) {
                	EmpEntity member = new EmpEntity();
                	member.setEmpIdx(Long.parseLong(userNo));
                	member.setEmpId(userId);
                	member.setEmpPwd("");
